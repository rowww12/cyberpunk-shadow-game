...
const Hero = () => {
  ...
  return <div className="relative h-[60vh] flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4">
        <h1 className={`text-5xl md:text-7xl font-extrabold mb-6 ${glitchText ? 'animate-pulse' : ''}`} onMouseOver={handleMouseOver}>
          <span className="text-emerald-300">CrackYour</span>
          <span className="bg-clip-text text-transparent bg-gradient-to-r from-cyberpunk-purple via-cyberpunk-pink to-cyberpunk-blue">Games</span>
          <span className="text-cyberpunk-orange"></span>
        </h1>
        ...
        <div className="flex justify-center">
          <Button className="bg-gradient-to-r from-cyberpunk-purple to-cyberpunk-pink hover:from-cyberpunk-pink hover:to-cyberpunk-purple text-white font-bold py-3 px-8 rounded-md transition-all duration-300 shadow-lg shadow-cyberpunk-purple/20" onMouseOver={handleMouseOver}>
            ACCÉDER AU CRACK
          </Button>
        </div>
      </div>
